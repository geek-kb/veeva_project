...
CREATE TABLE IF NOT EXISTS ${TEMP_MYSQL_DB_PRODUCTS_TABLE} (
...
CREATE TABLE IF NOT EXISTS ${TEMP_MYSQL_DB_USERS_TABLE} (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
INSERT INTO ${TEMP_MYSQL_DB_PRODUCTS_TABLE} (name, price) VALUES
('Product A', 19.99),
('Product B', 29.99),
('Product C', 39.99);
