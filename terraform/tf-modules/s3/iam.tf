...
#           "dynamodb:Query"
#         ],
#         Resource = "arn:aws:dynamodb:${var.aws_region}:${var.aws_account_id}:table/terraform-state-locks"
#       }
#     ]
#   })
# }
...
#         Effect : "Allow",
#         Principal : {
#           Service : "ec2.amazonaws.com" # Update based on your use case, e.g., specific user or service
#         },
